package com.igo.server.config;

import com.igo.server.jwt.JWTAuthorizationFilter;
import com.igo.server.jwt.JwtTokenProvider;
import com.igo.server.service.UserDetailsServiceImpl;
...
public class WebSecurityConfig  extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and()
                ...
                .antMatchers("/resources/**",  "/error", "/api/v1/user/**").permitAll()
